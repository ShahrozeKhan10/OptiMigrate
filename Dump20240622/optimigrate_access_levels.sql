...
CREATE TABLE `access_levels` (
  ...
  `feature` enum('country','urdu_language','consultant','country_expert','community') DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `payment_plan_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `payment_plan_id` (`payment_plan_id`),
  CONSTRAINT `access_levels_ibfk_1` FOREIGN KEY (`payment_plan_id`) REFERENCES `payment_plans` (`id`) ON DELETE SET NULL ON UPDATE CASCADE

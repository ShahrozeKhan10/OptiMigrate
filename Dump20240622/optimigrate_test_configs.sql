...
CREATE TABLE `test_configs` (
  ...
  `top_cand_skills_ctrl` int DEFAULT NULL,
  `total_cand_skills_ctrl` int DEFAULT NULL,
  `top_cand_skills_ctrl_prod` int DEFAULT NULL,
  `total_cand_skills_ctrl_prod` int DEFAULT NULL,

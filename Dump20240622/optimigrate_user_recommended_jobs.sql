...
CREATE TABLE `user_recommended_jobs` (
  ...
  KEY `job_id` (`job_id`),
  CONSTRAINT `user_recommended_jobs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_recommended_jobs_ibfk_2` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE

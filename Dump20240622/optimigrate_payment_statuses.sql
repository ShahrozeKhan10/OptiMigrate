...
CREATE TABLE `payment_statuses` (
  ...
  `date_creation` json DEFAULT NULL,
  ...
  CONSTRAINT `payment_statuses_ibfk_1` FOREIGN KEY (`payment_plan_id`) REFERENCES `payment_plans` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
